...
$MailMessage.from = ($ServerName + "@visionary.com") 
$MailMessage.To.add("mike@visionary.com") 
...
# 2. Have set $UseWebAdministrationSnapIn = $false and... 
# 3. Have manually specified targets below 
$FileExtension = ".evtx" 
 
# Short name to begin the filename of the .zip archive 
$TargetTypeName = "event-logs-" 
...
$ArchiveStorage = "E:\winevt_Logs_archives" 
...
$UseWebAdministrationSnapIn = $false 
...
if (!$UseWebAdministrationSnapIn) { 
    ...
    $Properties = @{ArchiveTargetName="*";  
                    ArchiveTargetFolder="C:\Windows\System32\winevt\Logs\archives\"} # Don't forget the trailing \  
